...
function startParentNode(text){
	...
	//document.write('	</td>');
	document.write('    <td><input type="checkbox" onclick="javascript:alert(2);"/><a class="parentTreeNode" name="parentNodeText' + parentNodeCount + '" onclick="onParentNodeTextClick(this)" style="cursor:pointer;">');
	document.write(text);
	document.write('</a>');
	document.write('  </td>');
	document.write('  </tr>');
...
function addNode(text, url, target){
	...
	document.write('<input type="checkbox" onclick="javascript:alert(1);"/>');
	document.write('	</td>');
