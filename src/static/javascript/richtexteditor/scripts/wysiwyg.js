...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "javascript/richtexteditor/images/";
		
		// Popups Directory
		this.PopupsDir = "javascript/richtexteditor/popups/";
		
		// CSS Directory File
		this.CSSFile = "javascript/richtexteditor/styles/wysiwyg.css";		
