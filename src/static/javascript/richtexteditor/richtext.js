// Images Directory
imagesDir = "brands/default/en/images/rte_icons/";

// CSS Directory
cssDir = "brands/default/en/css/";

// Popups Directory
popupsDir = "javascript/richtexteditor/popups/";
...
// Include Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="' +cssDir+ 'lms_rtf_styles.css">\n');
...
/* ---------------------------------------------------------------------- *\
Function    : generate_wysiwyg_withMargin()
Description : replace textarea with wysiwyg editor
Usage       : generate_wysiwyg("textarea_id", margin);
Arguments   : textarea_id - ID of textarea to replace, margin - margin to be added in second toolbar and iframe
\* ---------------------------------------------------------------------- */
function generate_wysiwyg_withMargin(textareaID, margin) {
...
var toolbar;
toolbar =  '<div style="padding-left:' + margin + 'px;"><table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;*float:left;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  if (buttonName[i]) {
    ...
    var buttonImage          = buttonObj[2];
		  var buttonImageRollover  = buttonObj[3];
		    ...
		    toolbar += '<td style="width: 22px;"><img src="' +buttonImage+ '" border=0 unselectable="on" title="' +buttonTitle+ '" id="' +buttonID+ '" class="button_tb" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button_tb\'){className=\'buttonOver\'}; this.src=\'' + buttonImageRollover + '\';" onmouseout="if(className==\'buttonOver\'){className=\'button_tb\'}; this.src=\'' + buttonImage + '\';" unselectable="on" width="20" height="20"></td>';
	    }
  }
  i++;
}
    ...
    var buttonImage          = buttonObj[2];
		  ...
		  if (buttonName2[j] == "seperator") {
		    ...
		    toolbar2 += '<td style="width: 22px;">';
				...
				toolbar2 += '<span id="textMode' + n + '"><img src="' +imagesDir+ 'view_text.gif" border=0 unselectable="on" title="viewText"          id="ViewText"       class="button_tb" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button_tb\'){className=\'buttonOver\'}; this.src=\'' +imagesDir+ 'view_text_on.gif\';"    onmouseout="if(className==\'buttonOver\'){className=\'button_tb\'}; this.src=\'' +imagesDir+ 'view_text.gif\';" unselectable="on"  width="20" height="20"></span>';
	      toolbar2 += '</td>';
			}
	    else {
...
toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px solid rgb(150, 150, 150);"><tr><td valign="top">\n'
...
function generate_wysiwyg(textareaID) {
  ...
  // Generate WYSIWYG toolbar one
  var toolbar;
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;*float:left;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
