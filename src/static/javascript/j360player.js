if (typeof j360player == "undefined") {
    ...
    (function (a) {
        a.html5.defaultSkin = function () {
			...
			this.text +='<elements><element name="background" src="ui/controllerBG.png"/>';
			this.text +='<element name="blankButton" src="ui/blank.png"/>';
			...
			this.text +='<element name="playButton" src="ui/playBtn.png"/>';
			this.text +='<element name="pauseButton" src="ui/pasueBtn.png"/>';
			...
			this.text +='<element name="timeSliderBuffer" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAN0lEQVRIDe3BwQkAMQwDMBcc55mRe9zi7RR+FCwBEWG39vcfGHFm4MTuhhMlwYlVBSdKhYh43AW/LQMKm1spzwAAAABJRU5ErkJggg=="/>';
			this.text +='<element name="timeSliderProgress" src="ui/scrollProgress.png"/>';
			this.text +='<element name="timeSliderThumb" src="ui/progressScroller.png"/>';
			this.text +='<element name="muteButton" src="ui/mute.png"/>';
			this.text +='<element name="unmuteButton" src="ui/unmute.png"/>';
			this.text +='<element name="volumeSliderRail" src="ui/volumeSliderRail.png"/>';
			this.text +='<element name="volumeSliderProgress" src="ui/volumeSliderProgress.png"/>';
			...
			this.text +='<element name="fullscreenButton" src="ui/fullScreen.png"/>';
			this.text +='<element name="normalscreenButton" src="ui/normalScreen.png"/></elements></component>';
			this.text +='<component name="display"><elements><element name="background" src="ui/iconBG.png"/>';
			this.text +='<element name="playIcon" src="ui/playB.png"/>';
			...
			this.text +='<element name="bufferIcon" src="ui/bufferIcon.png"/></elements></component>';
			this.text +='<component name="dock"><settings>';
			this.text +='<setting name="fontcolor" value="0xffffff"/></settings><elements>';
