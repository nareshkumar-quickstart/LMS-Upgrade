...
xx="";
	...
	//document.write('	</td>');
	document.write('    <td><input type="checkbox" name="orgGroups" '+xx+' onClick="" value='+id+' id=_orgGroup'+id+' "/><a class="parentTreeNode" name="parentNodeText' + parentNodeCount + '" onclick="" style="cursor:pointer;">');
	document.write(text);
	document.write('</a>');
	document.write('  </td>');
	document.write('  </tr>');
...
xx="";
	...
	document.write('<input type="checkbox"  name="orgGroups" '+xx+' onClick="" value='+id+' id=_orgGroup'+id+' "/>');
	document.write('	</td>');
