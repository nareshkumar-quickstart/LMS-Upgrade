...
xx="";
	...
	//document.write('	</td>');
	document.write('    <td><input type="checkbox" name="groups" '+xx+' onClick="" value="'+id+'" id="_orgGroup'+id+'"/>');
	document.write(text);
	//document.write('</a>');
	document.write('  </td>');
	document.write('  </tr>');
...
xx="";
	...
	document.write('<input type="checkbox"  name="groups" '+xx+' onClick="" value="'+id+'" id="_orgGroup'+id+'"/>');
	document.write('	</td>');
