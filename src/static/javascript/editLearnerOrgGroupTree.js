...
yy="";
	...
	//document.write('	</td>');
	document.write('    <td><input type="checkbox" name="groups" '+yy+' onClick="getLearnerGrpByOrgGroup(this.id);" value='+id+' id=_orgGroup'+id+' "/><a class="parentTreeNode" name="parentNodeText' + parentNodeCount + '" onclick="onParentNodeTextClick(this)" style="cursor:pointer;">');
	document.write(text);
	document.write('</a>');
	document.write('  </td>');
	document.write('  </tr>');
...
xx="";
	...
	document.write('<input type="checkbox"  name="groups" '+xx+'  onClick="getLearnerGrpByOrgGroup(this.id);" value='+id+' id=_orgGroup'+id+'  "/>');
	document.write('	</td>');
