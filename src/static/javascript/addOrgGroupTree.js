...
function startParentNode(text,id,selected){
	...
	//document.write('	</td>');
	document.write('    <td><input type="radio" name="groups" '+xx+' onClick="" value='+id+' id=_orgGroup'+id+' "/><a class="parentTreeNode" name="parentNodeText' + parentNodeCount + '" onclick="" style="cursor:pointer;">');
	document.write(text);
	document.write('</a>');
	document.write('  </td>');
	document.write('  </tr>');
...
function addNode(text, url, target,id,selected){
	...
	document.write('<input type="radio"  name="groups" '+xx+' onClick="" value='+id+' id=_orgGroup'+id+' "/>');
	document.write('	</td>');
