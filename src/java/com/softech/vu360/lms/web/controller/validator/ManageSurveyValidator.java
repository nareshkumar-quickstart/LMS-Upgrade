 ...
 *
 */
public class ManageSurveyValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		ManageSurveyForm form = (ManageSurveyForm) obj;
	...
	public void validateFirstPage( ManageSurveyForm form, Errors errors ) {
	...
	public void validateSecondPage(ManageSurveyForm form, Errors errors) {
		if(form.getSurveyQuestions().size() == 0){
			errors.rejectValue("surveyQuestions", "error.surveyQuestions.required");
		}
	}

	public void validateQuestion( ManageSurveyForm form, Errors errors ) {
		...
		if( questionType.equalsIgnoreCase(ManageSurveyWizardController.SURVEY_QUESTION_MULTIPLE_CHOICE_MULTIPLE_SELECT)) {
			...
			else if(form.getSurveyQuestionText().length() > 256) {
				errors.rejectValue("text", "error.question.characters.length");
			}
	...
	public void validateFinishPage(ManageSurveyForm form, Errors errors) {
	...
	public void validateSaveFlag(ManageSurveyForm form, Errors errors) {
	...
	public void validateSurveyResult(ManageSurveyForm form, Errors errors) {
		boolean flag=true;
