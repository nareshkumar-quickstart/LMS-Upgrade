...
public class AddDistributorEntitlementsForm  implements ILMSBaseInterface{

	private static final long serialVersionUID = 1L;
	public AddDistributorEntitlementsForm() {
	}
	...
	private List<CourseGroup> selectedCourses = new ArrayList<CourseGroup>();
	...
	private List<DistributorEntitlementCourseGroup> selectedCourseGroups = new ArrayList<DistributorEntitlementCourseGroup>();
...
*/
	...
	public List<CourseGroup> getSelectedCourses() {
		return selectedCourses;
	}

	public void setSelectedCourses(List<CourseGroup> selectedCourses) {
		this.selectedCourses = selectedCourses;
	}

	public List<DistributorEntitlementCourseGroup> getSelectedCourseGroups() {
		return selectedCourseGroups;
	}

	public void setSelectedCourseGroups(
			List<DistributorEntitlementCourseGroup> selectedCourseGroups) {
	...
	public void setPageIndex(int pageIndex) {
        ...
        /**
         * @param courseGroupIds the courseGroupIds to set
         */
