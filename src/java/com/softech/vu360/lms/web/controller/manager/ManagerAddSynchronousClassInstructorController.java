...
public class ManagerAddSynchronousClassInstructorController extends AbstractWizardFormController{
	private static final Logger log = Logger.getLogger(ManagerAddSynchronousClassInstructorController.class.getName());
	...
	public ManagerAddSynchronousClassInstructorController() {
		super();
		...
		setPages(new String[] {
				"manager/manageSynchronousClass/addInstructor/Step1",
				"manager/manageSynchronousClass/addInstructor/Step2", 
				"manager/manageSynchronousClass/addInstructor/Step3"});
	}
...
//		context.put("Id", classForm.getId());
		return new ModelAndView("redirect:mgr_editSynchronousClassInstructor.do?id="+assignInstructorForm.getId());
	}
