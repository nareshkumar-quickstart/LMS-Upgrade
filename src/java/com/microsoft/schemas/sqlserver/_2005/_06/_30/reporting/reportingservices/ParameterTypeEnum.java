...
public class ParameterTypeEnum implements java.io.Serializable {
    ...
    public static ParameterTypeEnum fromValue(java.lang.String value)
        ...
        ParameterTypeEnum enumeration = (ParameterTypeEnum)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParameterTypeEnum.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ParameterTypeEnum"));
    }
    /**
