...
public class ExecutionInfo2  extends com.microsoft.schemas.sqlserver._2005._06._30.reporting.reportingservices.ExecutionInfo  implements java.io.Serializable {
     ...
     * @param pageCountMode
     */
    public void setPageCountMode(com.microsoft.schemas.sqlserver._2005._06._30.reporting.reportingservices.PageCountMode pageCountMode) {
        this.pageCountMode = pageCountMode;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExecutionInfo2)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.pageCountMode==null && other.getPageCountMode()==null) || 
             (this.pageCountMode!=null &&
              this.pageCountMode.equals(other.getPageCountMode())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExecutionInfo2.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ExecutionInfo2"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("pageCountMode");
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "PageCountMode"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "PageCountMode"));
