...
public class ServerInfoHeader  implements java.io.Serializable {
     ...
     */
    public void setReportServerVersionNumber(java.lang.String reportServerVersionNumber) {
        this.reportServerVersionNumber = reportServerVersionNumber;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ServerInfoHeader)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.reportServerVersionNumber==null && other.getReportServerVersionNumber()==null) || 
             (this.reportServerVersionNumber!=null &&
              this.reportServerVersionNumber.equals(other.getReportServerVersionNumber()))) &&
            ((this.reportServerEdition==null && other.getReportServerEdition()==null) || 
             (this.reportServerEdition!=null &&
              this.reportServerEdition.equals(other.getReportServerEdition()))) &&
            ((this.reportServerVersion==null && other.getReportServerVersion()==null) || 
             (this.reportServerVersion!=null &&
              this.reportServerVersion.equals(other.getReportServerVersion()))) &&
            ((this.reportServerDateTime==null && other.getReportServerDateTime()==null) || 
             (this.reportServerDateTime!=null &&
              this.reportServerDateTime.equals(other.getReportServerDateTime())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ServerInfoHeader.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ServerInfoHeader"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reportServerVersionNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ReportServerVersionNumber"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ReportServerEdition"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ReportServerVersion"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", "ReportServerDateTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
